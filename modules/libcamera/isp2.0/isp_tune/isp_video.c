	...
	if (nr_update_param.multi_mode_enable == SENSOR_MULTI_MODE_FLAG) {
		switch(data_head->sub_type) {
			case BDN :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + bdn_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
			...
			case FLAT_OFFSET :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + flat_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
			...
			case GRGB :
			{
				...
				struct nr_param_ptr *nr_ptr = (struct nr_param_ptr*)nr_update_param.grgb_v1_level_ptr;
			...
			case IIR_YRANDOM :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + iir_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
			...
			case PRFY :
			{
				...
				memcpy((uint8_t*)(nr_ptr->common_param_ptr) + prey_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
			...
			case PWD :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + pwd_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
			...
			case RGB_PRECDN :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + rgb_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
			...
			case Y_AFM :
			{
				...
				memcpy(((uint8_t*)(nr_ptr->common_param_ptr)) + y_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
		...
		switch(data_head->sub_type) {
			...
			{
				static uint32_t bdn_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.bdn_level_ptr)) + bdn_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					bdn_ptr_offset += data_actual_len;
				else
					bdn_ptr_offset = 0;
			...
			{
				static uint32_t flat_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.flat_offset_level_ptr)) + flat_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					flat_ptr_offset += data_actual_len;
				else
					flat_ptr_offset = 0;
			...
			{
				static uint32_t grgb_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.grgb_v1_level_ptr)) + grgb_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					grgb_ptr_offset += data_actual_len;
				else
					grgb_ptr_offset = 0;
			...
			{
				static uint32_t iir_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.iircnr_yrandom_level_ptr)) + iir_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					iir_ptr_offset += data_actual_len;
				else
					iir_ptr_offset = 0;
			...
			{
				static uint32_t prey_ptr_offset;
				memcpy((uint8_t*)(nr_update_param.prfy_level_ptr) + prey_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					prey_ptr_offset += data_actual_len;
				else
					prey_ptr_offset = 0;
			...
			{
				static uint32_t pwd_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.pwd_level_ptr)) + pwd_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					pwd_ptr_offset += data_actual_len;
				else
					pwd_ptr_offset = 0;
			...
			{
				static uint32_t rgb_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.rgb_precdn_level_ptr)) + rgb_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					rgb_ptr_offset += data_actual_len;
				else
					rgb_ptr_offset = 0;
			...
			{
				static uint32_t y_ptr_offset;
				memcpy(((uint8_t*)(nr_update_param.y_afm_level_ptr)) + y_ptr_offset, (uint8_t*)data_actual_ptr, data_actual_len);
				if (0x01 != data_head->packet_status)
					y_ptr_offset += data_actual_len;
				else
					y_ptr_offset = 0;
...
int isp_denoise_read(uint8_t *tx_buf, uint32_t len, int file_num)
{
	int ret = ISP_SUCCESS;
	int num;
	MSG_HEAD_T *msg_ret;
	...
	if (nr_update_param.multi_mode_enable == SENSOR_MULTI_MODE_FLAG) {
		...
		switch(file_num) {
			...
			case GRGB :
			{
				data_head_ptr->sub_type = GRGB;
				src_size = sizeof(struct sensor_grgb_v1_level) * SENSOR_SMART_LEVEL_NUM;
				denoise_param_send(tx_buf, data_valid_len, (void*)nr_update_param.grgb_v1_level_ptr, src_size, data_ptr,
									&msg_ret->len, &data_head_ptr->packet_status);
				break;
			}
			case IIR_YRANDOM :
...
static int isp_nr_reg_read(isp_handle handler, uint8_t *tx_buf, uint32_t len, uint8_t *rx_buf)
{
	...
	if (0x01 == data_head->main_type) {
		ret = isp_denoise_read(tx_buf, len, data_head->sub_type);
