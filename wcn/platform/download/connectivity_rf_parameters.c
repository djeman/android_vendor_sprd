...
nvm_name_table g_config_table[] =
{
    ...
    WIFI_CONFIG_TABLE("CoexWifiScanCntPerChannel", coex_config.CoexWifiScanCntPerChannel, 1),
    WIFI_CONFIG_TABLE("CoexWifiScanDurationOneTime", coex_config.CoexWifiScanDurationOneTime, 1),
    WIFI_CONFIG_TABLE("CoexScoPeriodsToBlockDuringDhcp", coex_config.CoexScoPeriodsToBlockDuringDhcp, 1),
    WIFI_CONFIG_TABLE("CoexA2dpDhcpProtectLevel", coex_config.CoexA2dpDhcpProtectLevel, 1),
    WIFI_CONFIG_TABLE("CoexScoperiodsToBlockDuringEap", coex_config.CoexScoperiodsToBlockDuringEap, 1),
    WIFI_CONFIG_TABLE("CoexA2dpEapProtectLevel", coex_config.CoexA2dpEapProtectLevel, 1),
    WIFI_CONFIG_TABLE("CoexScoPeriodsToBlockDuringWifiJoin", coex_config.CoexScoPeriodsToBlockDuringWifiJoin, 1),
    WIFI_CONFIG_TABLE("CoexA2dpWifiJoinProtectLevel", coex_config.CoexA2dpWifiJoinProtectLevel, 1),
    WIFI_CONFIG_TABLE("CoexEnterPMStateTime", coex_config.CoexEnterPMStateTime, 2),
    WIFI_CONFIG_TABLE("CoexAclA2dpBtWorkTime", coex_config.CoexAclA2dpBtWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexAclA2dpWifiWorkTime", coex_config.CoexAclA2dpWifiWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexAclNoA2dpBtWorkTime", coex_config.CoexAclNoA2dpBtWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexAclNoA2dpWifiWorkTime", coex_config.CoexAclNoA2dpWifiWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexAclMixBtWorkTime", coex_config.CoexAclMixBtWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexAclMixWifiWorkTime", coex_config.CoexAclMixWifiWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexPageInqBtWorkTime", coex_config.CoexPageInqBtWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexPageInqWifiWorkTime", coex_config.CoexPageInqWifiWorkTime, 2),
    WIFI_CONFIG_TABLE("CoexScoSchema", coex_config.CoexScoSchema, 2),
    WIFI_CONFIG_TABLE("CoexDynamicScoSchemaEnable", coex_config.CoexDynamicScoSchemaEnable, 2),
    WIFI_CONFIG_TABLE("CoexScoPeriodsBtTakeAll", coex_config.CoexScoPeriodsBtTakeAll, 2),
    WIFI_CONFIG_TABLE("CoexLteTxAdvancedTime", coex_config.CoexLteTxAdvancedTime, 2),
    WIFI_CONFIG_TABLE("CoexLteOneSubFrameLen", coex_config.CoexLteOneSubFrameLen, 2),
    WIFI_CONFIG_TABLE("CoexLteTxTimerLen", coex_config.CoexLteTxTimerLen, 2),
    WIFI_CONFIG_TABLE("CoexLteTxTimerFrameHeadLen", coex_config.CoexLteTxTimerFrameHeadLen, 2),
    WIFI_CONFIG_TABLE("CoexLteStrategyFlag", coex_config.CoexLteStrategyFlag, 2),
    WIFI_CONFIG_TABLE("CoexWifiDegradePowerValue", coex_config.CoexWifiDegradePowerValue, 2),
    WIFI_CONFIG_TABLE("CoexBtDegradePowerValue", coex_config.CoexBtDegradePowerValue, 2),
    WIFI_CONFIG_TABLE("CoexWifi2300TxSpur2Lte", coex_config.CoexWifi2300TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2310TxSpur2Lte", coex_config.CoexWifi2310TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2320TxSpur2Lte", coex_config.CoexWifi2320TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2330TxSpur2Lte", coex_config.CoexWifi2330TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2340TxSpur2Lte", coex_config.CoexWifi2340TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2350TxSpur2Lte", coex_config.CoexWifi2350TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2360TxSpur2Lte", coex_config.CoexWifi2360TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2370TxSpur2Lte", coex_config.CoexWifi2370TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2380TxSpur2Lte", coex_config.CoexWifi2380TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2390TxSpur2Lte", coex_config.CoexWifi2390TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexWifi2400TxSpur2Lte", coex_config.CoexWifi2400TxSpur2Lte[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2300", coex_config.CoexLteTxSpur2Wifi2300[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2310", coex_config.CoexLteTxSpur2Wifi2310[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2320", coex_config.CoexLteTxSpur2Wifi2320[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2330", coex_config.CoexLteTxSpur2Wifi2330[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2340", coex_config.CoexLteTxSpur2Wifi2340[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2350", coex_config.CoexLteTxSpur2Wifi2350[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2360", coex_config.CoexLteTxSpur2Wifi2360[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2370", coex_config.CoexLteTxSpur2Wifi2370[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2380", coex_config.CoexLteTxSpur2Wifi2380[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2390", coex_config.CoexLteTxSpur2Wifi2390[0], 2),
    WIFI_CONFIG_TABLE("CoexLteTxSpur2Wifi2400", coex_config.CoexLteTxSpur2Wifi2400[0], 2),
...
nvm_name_table g_cali_table[] =
{
    ...
    WIFI_CALI_TABLE("txpower_psat_temperature", txpower_cali.txpower_psat_temperature, 4),
    WIFI_CALI_TABLE("txpower_psat_gainindex", txpower_cali.txpower_psat_gainindex, 1),

    WIFI_CALI_TABLE("txpower_psat_power", txpower_cali.txpower_psat_power, 2),
    WIFI_CALI_TABLE("txpower_psat_backoff", txpower_cali.txpower_psat_backoff, 1),
    WIFI_CALI_TABLE("txpower_psat_upper_limit", txpower_cali.txpower_psat_upper_limit, 1),
    WIFI_CALI_TABLE("txpower_psat_lower_limit", txpower_cali.txpower_psat_lower_limit, 1),

    WIFI_CALI_TABLE("txpower_freq_delta_gainindex", txpower_cali.txpower_freq_delta_gainindex[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel1", txpower_cali.txpower_temperature_delta_gm_channel1[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel2", txpower_cali.txpower_temperature_delta_gm_channel2[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel3", txpower_cali.txpower_temperature_delta_gm_channel3[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel4", txpower_cali.txpower_temperature_delta_gm_channel4[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel5", txpower_cali.txpower_temperature_delta_gm_channel5[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel6", txpower_cali.txpower_temperature_delta_gm_channel6[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel7", txpower_cali.txpower_temperature_delta_gm_channel7[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel8", txpower_cali.txpower_temperature_delta_gm_channel8[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel9", txpower_cali.txpower_temperature_delta_gm_channel9[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel10", txpower_cali.txpower_temperature_delta_gm_channel10[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel11", txpower_cali.txpower_temperature_delta_gm_channel11[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel12", txpower_cali.txpower_temperature_delta_gm_channel12[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel13", txpower_cali.txpower_temperature_delta_gm_channel13[0], 1),
    WIFI_CALI_TABLE("txpower_temperature_delta_gm_channel14", txpower_cali.txpower_temperature_delta_gm_channel14[0], 1),
    ...
    WIFI_CALI_TABLE("channel1_dpd_cali_table", dpd_cali.channel1_dpd_cali_table[0], 4),
    WIFI_CALI_TABLE("channel2_dpd_cali_table", dpd_cali.channel2_dpd_cali_table[0], 4),
    WIFI_CALI_TABLE("channel3_dpd_cali_table", dpd_cali.channel3_dpd_cali_table[0], 4),
...
static int wifi_nvm_set_cmd(nvm_name_table *pTable, nvm_cali_cmd *cmd, void *p_data)
{
	int i;
	unsigned char  *p;
...
/*type 1:  configure file */
/*type 2:  calibration file*/
static int wifi_nvm_buf_operate(char *pBuf, int file_len, const int type, void *p_data)
{
	int i, p;
	nvm_cali_cmd cmd;
	nvm_name_table *pTable = NULL;
...
int wlan_save_cali_data_to_file(wifi_cali_cp_t *data_cp)
{
    ...
    p += sprintf(p,"[SETCTION 0]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# Marlin cali Version info\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    ...
    p += sprintf(p,"rxiq_cali_en    = %d\n",cc->rxiq_cali_en);
    p += sprintf(p,"txpower_cali_en = %d\n",cc->txpower_cali_en);
    p += sprintf(p,"dpd_cali_en     = %d\n",cc->dpd_cali_en);
    p += sprintf(p,"config_reserved = %d, %d, %d, %d\n\n",cc->config_reserved[0],cc->config_reserved[1],
                                                          cc->config_reserved[2],cc->config_reserved[3]);
    rctune_cali_t *rc = &data->rctune_cali;
    p += sprintf(p,"[SETCTION 2]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# rc calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"rctune_value    = 0x%x\n",rc->rctune_value);
    p += sprintf(p,"rc_cali_reserved= 0x%x, 0x%x, 0x%x\n\n",rc->rctune_reserved[0],
                                                    rc->rctune_reserved[1],rc->rctune_reserved[2]);

    dcoc_cali_t *dc = &data->dcoc_cali;
    unsigned short *dc_dcc = &dc->dcoc_cali_code[0];
    unsigned int *dc_dr = &dc->dcoc_reserved[0];
    p += sprintf(p,"[SETCTION 3]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# doco calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"dcoc_cali_code    = ");
    for(i=0; i<18; i++){
        p += sprintf(p,"0x%x",*dc_dcc);
        if(i != 18-1)
            p += sprintf(p,", ");
        dc_dcc++;
    }
    p += sprintf(p,"\n");
    p += sprintf(p,"dcoc_reserved   = 0x%x, 0x%x, 0x%x, 0x%x\n\n",dc_dr[0],dc_dr[1],dc_dr[2],dc_dr[3]);

    txiq_cali_t *txc = &data->txiq_cali;
    unsigned int *txc_txr = &txc->txiq_reserved[0];
    p += sprintf(p,"[SETCTION 4]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# txiq calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"rf_txiq_c11     = 0x%x\n",txc->rf_txiq_c11);
    p += sprintf(p,"rf_txiq_c12     = 0x%x\n",txc->rf_txiq_c12);
    p += sprintf(p,"rf_txiq_c22     = 0x%x\n",txc->rf_txiq_c22);
    p += sprintf(p,"rf_txiq_dc      = 0x%x\n",txc->rf_txiq_dc);
    p += sprintf(p,"txiq_reserved   = 0x%x, 0x%x, 0x%x, 0x%x\n",txc_txr[0],txc_txr[1],txc_txr[2],txc_txr[3]);
    p += sprintf(p,"\n");

    rxiq_cali_t *rxc = &data->rxiq_cali;
    unsigned int *rxc_rxr = &rxc->rxiq_reserved[0];
    p += sprintf(p,"[SETCTION 5]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# rxiq calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"rf_rxiq_coef21_22   = 0x%x\n",rxc->rf_rxiq_coef21_22);
    p += sprintf(p,"rf_rxiq_coef11_12   = 0x%x\n",rxc->rf_rxiq_coef11_12);
    p += sprintf(p,"rxiq_reserved       = 0x%x, 0x%x\n",rxc_rxr[0],rxc_rxr[1]);
    p += sprintf(p,"\n");
    ...
    p += sprintf(p,"[SETCTION 6]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# txpower calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"txpower_psat_temperature   = %d\n",txpc->txpower_psat_temperature);
    p += sprintf(p,"txpower_psat_gainindex   = %d\n",txpc->txpower_psat_gainindex);
    p += sprintf(p,"txpower_psat_power   = %d\n",txpc->txpower_psat_power);
    p += sprintf(p,"txpower_psat_backoff   = %d\n",txpc->txpower_psat_backoff);
    p += sprintf(p,"txpower_psat_upper_limit   = %d\n",txpc->txpower_psat_upper_limit);
    p += sprintf(p,"txpower_psat_lower_limit   = %d\n",txpc->txpower_psat_lower_limit);
    p += sprintf(p,"txpower_freq_delta_gainindex = ");
    for(i=0;i<14;i++){
        p += sprintf(p,"%d",*txpc_fdg);
        if(i != 14-1)
            p += sprintf(p,", ");
        txpc_fdg++;
    }
    p += sprintf(p,"\n");
    for(i=0;i<14;i++){
        p += sprintf(p,"txpower_temperature_delta_gm_channel%d = ",i+1);
        for(j=0;j<32;j++){
            p += sprintf(p,"%d",ch[i][j]);
            if(j != 32-1)
                p += sprintf(p,", ");
        }
        p += sprintf(p,"\n");
    }
    p += sprintf(p,"txpower_reserved   = %d, %d, %d, %d\n",txpc_tr[0],txpc_tr[1],txpc_tr[2],txpc_tr[3]);
    ...
    p += sprintf(p,"[SETCTION 7]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# DPD calibration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"dpd_cali_channel_num   = %d\n",dpd->dpd_cali_channel_num);
    p += sprintf(p,"dpd_cali_channel   = %d, %d, %d\n",
            dpd->dpd_cali_channel[0],dpd->dpd_cali_channel[1],dpd->dpd_cali_channel[2]);
    for(i=0;i<3;i++){
        p += sprintf(p,"channel%d_dpd_cali_table = ",i+1);
        for(j=0;j<182;j++){
            p += sprintf(p,"0x%x",dpd_ch[i][j]);
            if(j != 182-1)
                p += sprintf(p,", ");
        }
        p += sprintf(p,"\n");
    }
    p += sprintf(p,"dpd_reserved   = 0x%x, 0x%x, 0x%x, 0x%x\n",
            dpd->dpd_reserved[0],dpd->dpd_reserved[1],dpd->dpd_reserved[2],dpd->dpd_reserved[3]);

    rf_para_t *rp = &data->rf_para;
    unsigned char *rp_rfc = &rp->rf_ctune[0];
    p += sprintf(p,"[SETCTION 8]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# RF parameters data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"rf_ctune = ");
    for(i=0;i<14;i++){
        p += sprintf(p,"%d",*rp_rfc);
        if(i != 14-1)
            p += sprintf(p,", ");
        rp_rfc++;
    }
    p += sprintf(p,"\n");
    p += sprintf(p,"rf_reserved = %d, %d, %d, %d\n\n",rp->rf_reserved[0],rp->rf_reserved[1],rp->rf_reserved[2],rp->rf_reserved[3]);


    tpc_cfg_t *tpc = &data->tpc_cfg;
    unsigned int *tpc_cfg = &tpc->tpc_cfg[0];
    p += sprintf(p,"[SETCTION 9]\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"# TPC Configuration data\n");
    p += sprintf(p,"#-----------------------------------------------------------------\n");
    p += sprintf(p,"tpc_cfg = ");
    for(i=0;i<37;i++){
        p += sprintf(p,"0x%x",*tpc_cfg);
        if(i != 37-1)
            p += sprintf(p,", ");
        tpc_cfg++;
    }
    p += sprintf(p,"\n");
    p += sprintf(p,"tpc_reserved = 0x%x, 0x%x, 0x%x, 0x%x\n\n",
        tpc->tpc_reserved[0],tpc->tpc_reserved[1],tpc->tpc_reserved[2],tpc->tpc_reserved[3]);
    p += sprintf(p,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
...
#ifdef GET_MARLIN_CHIPID
    RFDBG("%s(), marlin.hardware.version=0x%x\n", __func__, marlin_img_flag.which_img_flag);
    if(BSL_REP_IS_2331_BA == marlin_img_flag.which_img_flag)
        strcpy(config_ini_path, SYSTEM_WIFI_BA_CONFIG_FILE);
    else
        strcpy(config_ini_path, SYSTEM_WIFI_CONFIG_FILE);
#else
    strcpy(config_ini_path, SYSTEM_WIFI_CONFIG_FILE);
#endif
    ret = wifi_nvm_parse(config_ini_path, 1, (void *)p);
    if(0 != ret){
        RFDBG("%s(),parse %s, err[%d]\n", __FUNCTION__, config_ini_path, ret);
        return -1;
        }
    RFDBG("%s(), access to configure.ini in %s success. \n", __FUNCTION__, config_ini_path);
    return 0;
}
...
int get_connectivity_cali_param(wifi_cali_t* p)
{
    ...
    RFDBG("%s(), marlin.hardware.version=0x%x\n", __func__, marlin_img_flag.which_img_flag);
    if(BSL_REP_IS_2331_BA == marlin_img_flag.which_img_flag)
        strcpy(cali_ini_path, SYSTEM_WIFI_BA_CALI_FILE);
	else
        strcpy(cali_ini_path, SYSTEM_WIFI_CALI_FILE);
#else
    strcpy(cali_ini_path, SYSTEM_WIFI_CALI_FILE);
#endif
    ret = wifi_nvm_parse(cali_ini_path, 2, (void *)p);
    if(0 != ret){
        RFDBG("%s(),parse %s, err[%d]\n", __FUNCTION__, cali_ini_path, ret);
        return -1;
        }
    RFDBG("%s(), access to configure.ini in %s success. \n", __FUNCTION__, cali_ini_path);
    return 0;
}
...
int main()
{
    ...
    wifi_cali_t wifi_cali_data;
    wifi_cali_cp_t wifi_cali_cp_data;

    printf("sizeof(wifi_config_t) = %ld\n",sizeof(wifi_config_t));
    printf("sizeof(wifi_cali_t) =%ld\n",sizeof(wifi_cali_t));
    printf("sizeof(wifi_cali_cp_t) =%ld\n",sizeof(wifi_cali_cp_t));

    get_connectivity_config_param(&wifi_config_data);
    get_connectivity_cali_param(&wifi_cali_data);

    wifi_cali_cp_data.wifi_cali = wifi_cali_data;

    wlan_save_cali_data_to_file(&wifi_cali_cp_data);
